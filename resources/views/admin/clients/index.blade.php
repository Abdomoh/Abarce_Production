    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="">
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i>&nbsp;اضافة عميل </button><br><br>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='5'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$client->id}}</td>
                                <td>{{$client->name}}</td>
                                <td data-toggle="modal" data-target="#img_show{{$client->id}}"><img src="{{'/storage/'.$client->logo}}" width="40px" class="rounded-circle">
                                </td>

                                <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit{{$client->id}}" title="">
                                        <i class="fa fa-edit"></i></button></td>

                                <td>

                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{$client->id}}" title="">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('clients.update',$client->id)}}"  method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="logo" value="{{$client->logo}}" class="form-control" />
                                                    <input id="id" type="hidden" name="id" class="form-control" value="{{$client->id}}">
                                                </div>
                            ...
                            <!--  img- show -->
                            <div class="modal fade" id="img_show{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <center><img src="{{'/storage/'.$client->logo}}" width="400px" class="rounded-circle"></center>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{route('clients.store')}}" method="post" enctype="multipart/form-data" autocomplete="">
                        {{ csrf_field() }}
                        <div class="modal-body">
