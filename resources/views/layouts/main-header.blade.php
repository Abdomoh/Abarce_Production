    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{ url('dashboard') }}"><img src="{{ URL::asset('/storage/'.$seeting->logo) }}"
                        class="logo-1" alt="logo"></a>
                <a href="{{ URL::asset('/storage/'.$seeting->logo) }}"
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span
                                    class="badge badge-pill badge-warning mr-auto my-auto float-left">{{ $contact_count }}</span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">البريد
                                الوارد{{ $contact_count }}</p>
                        </div>
                        @foreach ($contacts as $contact)
                            <div class="main-message-list chat-scroll">
                                <a href="{{route('contacts.show' ,$contact->id)}}" class="p-3 d-flex border-bottom">
                                    ...
                                    <div class="wd-90p">
                                        <div class="d-flex">
                                            <h5 class="mb-1 name"> {{ $contact->full_name }}</h5>
                                        </div>
                                        <p class="mb-0 desc">{{Str::limit( $contact->message,20) }}</p>
                        ...
                        <div class="text-center dropdown-footer">
                            <a href="{{ route('contacts.index') }}"> جميع الرسائل</a>
                        </div>
                    </div>
                </div>
